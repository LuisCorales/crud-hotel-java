 ...
 */
public class Anteriores extends javax.swing.JInternalFrame {
     ...
     */
    public Anteriores(Admin recepcionP) {
        initComponents();
        this.recepcion = recepcionP;
    }
    
    public void leerAnteriores(int habitacion) throws IOException{
        try{
    ...
    private void initComponents() {
        ...
        setIconifiable(true);
        setTitle("Reporte de reservas finalizadas");
    ...
    private void habitacionComboBoxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_habitacionComboBoxActionPerformed
        ...
        if(this.habitacionComboBox.getSelectedIndex()>0){
            try {
                leerAnteriores((this.habitacionComboBox.getSelectedIndex()-1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Anteriores.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                new Anteriores(recepcionP).setVisible(true);
            }
        });
    }
